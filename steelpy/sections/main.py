...
# package imports
from steelpy.sections.shapes.angle import AngleSQLite, AngleInMemory
from steelpy.sections.shapes.tubular import TubularInMemory, TubularSQLite
from steelpy.sections.shapes.tee import TeeSQLite, TeeInMemory
from steelpy.sections.shapes.channel import ChannelSQLite, ChannelInMemory
from steelpy.sections.shapes.box import BoxSQLite, BoxInMemory
from steelpy.sections.shapes.ibeam import IbeamInMemory, IbeamSQLite
from steelpy.sections.shapes.solid import CircleInMemory, CircleSQLite, RectangleSQLite, RectangleInMemory
from steelpy.sections.process.io_sections import PropertyOut, get_sect_properties
#
    ...
    def __setitem__(self, shape_name: Union[str, int],
        ...
        try:
            ...
            if re.match(r"\b(i((\_)?beam|section)?|w|m|s|hp|ub|uc|he|ipe)\b"
                ...
                self._sections[shape_name] = AngleInMemory(name=shape_name, 
                                                           d=properties[0], tw=properties[1], 
                                                           b=properties[2], r=properties[3])            
