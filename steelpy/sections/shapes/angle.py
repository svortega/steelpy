...
#
#
class AngleInMemory(AngleBasic):
    """ """
    __slots__ = ['heigh', 'thickness', 'base', 'root', 'build', 
                 'shear_stress', 'compactness', '_properties',
                 'FAvy', 'FAvz', 'name', 'number']
    
    def __init__(self, name:Union[str, int],
                 d:Union[float,None], tw:Union[float,None], 
                 b:Union[float,None], r:Union[float,None], 
                 build:str = 'welded', 
...
#
#
class AngleSQLite(AngleBasic, SectionSQLite):
    """ """
