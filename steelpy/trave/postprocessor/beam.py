...
def get_force(conn, element_name: int|str|None=None,
    ...
    if element_name:
        #project = (node_name,)
        query = f'SELECT {item} FROM tb_Qbeam WHERE element_name = {element_name}'
    else:
        query = f'SELECT {item} FROM tb_Qbeam'
...
def get_displacement(conn, element_name: int|str|None=None,
    ...
    if element_name:
        #project = (node_name,)
        query = f'SELECT {item} FROM tb_Dbeam WHERE element_name = {element_name}'
    else:
        query = f'SELECT {item} FROM tb_Dbeam'
...
def get_stress(conn, element_name: int|str|None=None,
    ...
    if element_name:
        #project = (node_name,)
        query = f'SELECT {item} FROM tb_Sbeam WHERE element_name = {element_name}'
    else:
        query = f'SELECT {item} FROM tb_Sbeam'
