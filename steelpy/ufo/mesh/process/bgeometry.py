...
#
#
def Kt_tensionX(Le:float, Ax:float,
               Jx:float, Iy:float, Iz:float,
               Emod:float, Gmod:float,
               Oy:float, Oz:float,
               Fb:list[float]):
    ...
    et[0,0] = P/L + (A*E)/L
    et[1,1] = (Vy*(Iz*Vy**2*P*sinh(L*Vy) - 3*A*P*sinh(L*Vy) + 2*A*L*Vy*P - Iz*L*Vy**3*P - A*E*Iz*L*Vy**3 + A*E*Iz*Vy**2*sinh(L*Vy) - 2*A*L**3*Vy**3*Oy*P + A*L*Vy*P*cosh(L*Vy) + A*L**5*Vy**5*Oy**2*P + 2*A*L**2*Vy**2*Oy*P*sinh(L*Vy) + A*L**4*Vy**4*Oy**2*P*sinh(L*Vy) + A*E*Iz*L**3*Vy**5*Oy + A*E*Iz*L**2*Vy**4*Oy*sinh(L*Vy)))/(2*A*(L*Vy*cosh((L*Vy)/2) - 2*sinh((L*Vy)/2) + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2))**2)
    et[2,2] = (Vz*(Iy*Vz**2*P*sinh(L*Vz) - 3*A*P*sinh(L*Vz) + 2*A*L*Vz*P - Iy*L*Vz**3*P - A*E*Iy*L*Vz**3 + A*E*Iy*Vz**2*sinh(L*Vz) - 2*A*L**3*Vz**3*Oz*P + A*L*Vz*P*cosh(L*Vz) + A*L**5*Vz**5*Oz**2*P + 2*A*L**2*Vz**2*Oz*P*sinh(L*Vz) + A*L**4*Vz**4*Oz**2*P*sinh(L*Vz) + A*E*Iy*L**3*Vz**5*Oz + A*E*Iy*L**2*Vz**4*Oz*sinh(L*Vz)))/(2*A*(L*Vz*cosh((L*Vz)/2) - 2*sinh((L*Vz)/2) + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2))**2)
    et[3,3] = (Jp*P)/(A*L)
    et[4,4] = (A*P*sinh(2*L*Vz) - 2*A*P*sinh(L*Vz) - 2*Iy*Vz**2*P*sinh(L*Vz) + Iy*Vz**2*P*sinh(2*L*Vz) - A*L**3*Vz**3*P + Iy*L**3*Vz**5*P - Iy*L*Vz**3*P - A*E*Iy*L*Vz**3 - 2*A*E*Iy*Vz**2*sinh(L*Vz) + A*E*Iy*Vz**2*sinh(2*L*Vz) + 2*Iy*L*Vz**3*P*cosh(L*Vz) - Iy*L*Vz**3*P*cosh(2*L*Vz) + A*E*Iy*L**3*Vz**5 - 5*A*L**3*Vz**3*Oz*P + 2*A*L**5*Vz**5*Oz*P + 3*Iy*L**3*Vz**5*Oz*P + 2*A*L**2*Vz**2*P*sinh(L*Vz) + (A*L**2*Vz**2*P*sinh(2*L*Vz))/2 - 2*Iy*L**2*Vz**4*P*sinh(L*Vz) + (Iy*L**2*Vz**4*P*sinh(2*L*Vz))/2 + 2*A*L*Vz*P*cosh(L*Vz) - 2*A*L*Vz*P*cosh(2*L*Vz) + 12*A*L**5*Vz**5*Oz**2*P - A*L**7*Vz**7*Oz**2*P - 9*A*L**7*Vz**7*Oz**3*P + 2*A*L**9*Vz**9*Oz**4*P - 2*Iy*L**5*Vz**7*Oz**2*P + 8*A*L**2*Vz**2*Oz*P*sinh(L*Vz) - 4*A*L**2*Vz**2*Oz*P*sinh(2*L*Vz) - 6*A*L**4*Vz**4*Oz*P*sinh(L*Vz) - A*L**4*Vz**4*Oz*P*sinh(2*L*Vz) + 4*Iy*L**2*Vz**4*Oz*P*sinh(L*Vz) - 2*Iy*L**2*Vz**4*Oz*P*sinh(2*L*Vz) + 2*Iy*L**4*Vz**6*Oz*P*sinh(L*Vz) - 7*A*E*Iy*L**5*Vz**7*Oz**2 + 2*A*E*Iy*L**7*Vz**9*Oz**3 - 8*A*L**5*Vz**5*Oz**2*P*cosh(L*Vz) - 4*A*L**5*Vz**5*Oz**2*P*cosh(2*L*Vz) + 8*A*L**7*Vz**7*Oz**3*P*cosh(L*Vz) + A*L**7*Vz**7*Oz**3*P*cosh(2*L*Vz) - 2*A*L**9*Vz**9*Oz**4*P*cosh(L*Vz) + 2*Iy*L**5*Vz**7*Oz**2*P*cosh(L*Vz) - 12*A*L**4*Vz**4*Oz**2*P*sinh(L*Vz) + 6*A*L**4*Vz**4*Oz**2*P*sinh(2*L*Vz) + 6*A*L**6*Vz**6*Oz**2*P*sinh(L*Vz) + 8*A*L**6*Vz**6*Oz**3*P*sinh(L*Vz) + (A*L**6*Vz**6*Oz**2*P*sinh(2*L*Vz))/2 - 4*A*L**6*Vz**6*Oz**3*P*sinh(2*L*Vz) - 2*A*L**8*Vz**8*Oz**3*P*sinh(L*Vz) - 2*A*L**8*Vz**8*Oz**4*P*sinh(L*Vz) + A*L**8*Vz**8*Oz**4*P*sinh(2*L*Vz) - 2*Iy*L**4*Vz**6*Oz**2*P*sinh(L*Vz) + Iy*L**4*Vz**6*Oz**2*P*sinh(2*L*Vz) + 2*A*E*Iy*L*Vz**3*cosh(L*Vz) - A*E*Iy*L*Vz**3*cosh(2*L*Vz) + 6*A*E*Iy*L**3*Vz**5*Oz - A*E*Iy*L**5*Vz**7*Oz - 2*A*E*Iy*L**2*Vz**4*sinh(L*Vz) + (A*E*Iy*L**2*Vz**4*sinh(2*L*Vz))/2 + 5*A*L**3*Vz**3*Oz*P*cosh(2*L*Vz) - 4*Iy*L**3*Vz**5*Oz*P*cosh(L*Vz) + Iy*L**3*Vz**5*Oz*P*cosh(2*L*Vz) - 6*A*E*Iy*L**3*Vz**5*Oz*cosh(L*Vz) + 2*A*E*Iy*L**2*Vz**4*Oz*sinh(L*Vz) - A*E*Iy*L**2*Vz**4*Oz*sinh(2*L*Vz) + 4*A*E*Iy*L**4*Vz**6*Oz*sinh(L*Vz) + (A*E*Iy*L**4*Vz**6*Oz*sinh(2*L*Vz))/2 + 6*A*E*Iy*L**5*Vz**7*Oz**2*cosh(L*Vz) + A*E*Iy*L**5*Vz**7*Oz**2*cosh(2*L*Vz) - 2*A*E*Iy*L**7*Vz**9*Oz**3*cosh(L*Vz) + 2*A*E*Iy*L**4*Vz**6*Oz**2*sinh(L*Vz) - A*E*Iy*L**4*Vz**6*Oz**2*sinh(2*L*Vz) - 2*A*E*Iy*L**6*Vz**8*Oz**2*sinh(L*Vz) - 2*A*E*Iy*L**6*Vz**8*Oz**3*sinh(L*Vz) + A*E*Iy*L**6*Vz**8*Oz**3*sinh(2*L*Vz))/(2*A*Vz*(cosh(L*Vz) - 1)*(4*cosh(L*Vz) + L**2*Vz**2 + 8*L**2*Vz**2*Oz + L**2*Vz**2*cosh(L*Vz) - 4*L*Vz*sinh(L*Vz) - 4*L**4*Vz**4*Oz**2 - 8*L**2*Vz**2*Oz*cosh(L*Vz) + 4*L**3*Vz**3*Oz*sinh(L*Vz) + 4*L**4*Vz**4*Oz**2*cosh(L*Vz) - 4))
    et[5,5] = (A*P*sinh(2*L*Vy) - 2*A*P*sinh(L*Vy) - 2*Iz*Vy**2*P*sinh(L*Vy) + Iz*Vy**2*P*sinh(2*L*Vy) - A*L**3*Vy**3*P + Iz*L**3*Vy**5*P - Iz*L*Vy**3*P - A*E*Iz*L*Vy**3 - 2*A*E*Iz*Vy**2*sinh(L*Vy) + A*E*Iz*Vy**2*sinh(2*L*Vy) + 2*Iz*L*Vy**3*P*cosh(L*Vy) - Iz*L*Vy**3*P*cosh(2*L*Vy) + A*E*Iz*L**3*Vy**5 - 5*A*L**3*Vy**3*Oy*P + 2*A*L**5*Vy**5*Oy*P + 3*Iz*L**3*Vy**5*Oy*P + 2*A*L**2*Vy**2*P*sinh(L*Vy) + (A*L**2*Vy**2*P*sinh(2*L*Vy))/2 - 2*Iz*L**2*Vy**4*P*sinh(L*Vy) + (Iz*L**2*Vy**4*P*sinh(2*L*Vy))/2 + 2*A*L*Vy*P*cosh(L*Vy) - 2*A*L*Vy*P*cosh(2*L*Vy) + 12*A*L**5*Vy**5*Oy**2*P - A*L**7*Vy**7*Oy**2*P - 9*A*L**7*Vy**7*Oy**3*P + 2*A*L**9*Vy**9*Oy**4*P - 2*Iz*L**5*Vy**7*Oy**2*P + 8*A*L**2*Vy**2*Oy*P*sinh(L*Vy) - 4*A*L**2*Vy**2*Oy*P*sinh(2*L*Vy) - 6*A*L**4*Vy**4*Oy*P*sinh(L*Vy) - A*L**4*Vy**4*Oy*P*sinh(2*L*Vy) + 4*Iz*L**2*Vy**4*Oy*P*sinh(L*Vy) - 2*Iz*L**2*Vy**4*Oy*P*sinh(2*L*Vy) + 2*Iz*L**4*Vy**6*Oy*P*sinh(L*Vy) - 7*A*E*Iz*L**5*Vy**7*Oy**2 + 2*A*E*Iz*L**7*Vy**9*Oy**3 - 8*A*L**5*Vy**5*Oy**2*P*cosh(L*Vy) - 4*A*L**5*Vy**5*Oy**2*P*cosh(2*L*Vy) + 8*A*L**7*Vy**7*Oy**3*P*cosh(L*Vy) + A*L**7*Vy**7*Oy**3*P*cosh(2*L*Vy) - 2*A*L**9*Vy**9*Oy**4*P*cosh(L*Vy) + 2*Iz*L**5*Vy**7*Oy**2*P*cosh(L*Vy) - 12*A*L**4*Vy**4*Oy**2*P*sinh(L*Vy) + 6*A*L**4*Vy**4*Oy**2*P*sinh(2*L*Vy) + 6*A*L**6*Vy**6*Oy**2*P*sinh(L*Vy) + 8*A*L**6*Vy**6*Oy**3*P*sinh(L*Vy) + (A*L**6*Vy**6*Oy**2*P*sinh(2*L*Vy))/2 - 4*A*L**6*Vy**6*Oy**3*P*sinh(2*L*Vy) - 2*A*L**8*Vy**8*Oy**3*P*sinh(L*Vy) - 2*A*L**8*Vy**8*Oy**4*P*sinh(L*Vy) + A*L**8*Vy**8*Oy**4*P*sinh(2*L*Vy) - 2*Iz*L**4*Vy**6*Oy**2*P*sinh(L*Vy) + Iz*L**4*Vy**6*Oy**2*P*sinh(2*L*Vy) + 2*A*E*Iz*L*Vy**3*cosh(L*Vy) - A*E*Iz*L*Vy**3*cosh(2*L*Vy) + 6*A*E*Iz*L**3*Vy**5*Oy - A*E*Iz*L**5*Vy**7*Oy - 2*A*E*Iz*L**2*Vy**4*sinh(L*Vy) + (A*E*Iz*L**2*Vy**4*sinh(2*L*Vy))/2 + 5*A*L**3*Vy**3*Oy*P*cosh(2*L*Vy) - 4*Iz*L**3*Vy**5*Oy*P*cosh(L*Vy) + Iz*L**3*Vy**5*Oy*P*cosh(2*L*Vy) - 6*A*E*Iz*L**3*Vy**5*Oy*cosh(L*Vy) + 2*A*E*Iz*L**2*Vy**4*Oy*sinh(L*Vy) - A*E*Iz*L**2*Vy**4*Oy*sinh(2*L*Vy) + 4*A*E*Iz*L**4*Vy**6*Oy*sinh(L*Vy) + (A*E*Iz*L**4*Vy**6*Oy*sinh(2*L*Vy))/2 + 6*A*E*Iz*L**5*Vy**7*Oy**2*cosh(L*Vy) + A*E*Iz*L**5*Vy**7*Oy**2*cosh(2*L*Vy) - 2*A*E*Iz*L**7*Vy**9*Oy**3*cosh(L*Vy) + 2*A*E*Iz*L**4*Vy**6*Oy**2*sinh(L*Vy) - A*E*Iz*L**4*Vy**6*Oy**2*sinh(2*L*Vy) - 2*A*E*Iz*L**6*Vy**8*Oy**2*sinh(L*Vy) - 2*A*E*Iz*L**6*Vy**8*Oy**3*sinh(L*Vy) + A*E*Iz*L**6*Vy**8*Oy**3*sinh(2*L*Vy))/(2*A*Vy*(cosh(L*Vy) - 1)*(4*cosh(L*Vy) + L**2*Vy**2 + 8*L**2*Vy**2*Oy + L**2*Vy**2*cosh(L*Vy) - 4*L*Vy*sinh(L*Vy) - 4*L**4*Vy**4*Oy**2 - 8*L**2*Vy**2*Oy*cosh(L*Vy) + 4*L**3*Vy**3*Oy*sinh(L*Vy) + 4*L**4*Vy**4*Oy**2*cosh(L*Vy) - 4))

    et[2,3] = Mza/L
    et[3,4] = - Mza/2 - ((Oz*L**2*Vz**2 - 1)*(Mza + Mzb)*(L*Vz - 2*sinh(L*Vz) - 2*cosh(L*Vz) + L*Vz*(cosh(L*Vz) + sinh(L*Vz)) + 2))/(L**2*Vz**2*(cosh(L*Vz) + sinh(L*Vz) - 1))    
    et[5,6] = Mza/L
    et[8,9] = -Mzb/L
    et[9,10] = - Mzb/2 - ((Oz*L**2*Vz**2 - 1)*(Mza + Mzb)*(L*Vz - 2*sinh(L*Vz) - 2*cosh(L*Vz) + L*Vz*(cosh(L*Vz) + sinh(L*Vz)) + 2))/(L**2*Vz**2*(cosh(L*Vz) + sinh(L*Vz) - 1))

    et[1,3] = Mya/L
    et[2,4] = -(A*L**2*Vz**2*P - 8*A*P*sinh((L*Vz)/2)**2 - Iy*L**2*Vz**4*P + Iy*L*Vz**3*P*sinh(L*Vz) - A*E*Iy*L**2*Vz**4 - 2*A*L**4*Vz**4*Oz*P + A*L*Vz*P*sinh(L*Vz) + A*L**6*Vz**6*Oz**2*P - 2*A*L**3*Vz**3*Oz*P*sinh(L*Vz) + 16*A*L**2*Vz**2*Oz*P*sinh((L*Vz)/2)**2 + A*L**5*Vz**5*Oz**2*P*sinh(L*Vz) + A*E*Iy*L*Vz**3*sinh(L*Vz) - 8*A*L**4*Vz**4*Oz**2*P*sinh((L*Vz)/2)**2 + A*E*Iy*L**4*Vz**6*Oz + A*E*Iy*L**3*Vz**5*Oz*sinh(L*Vz))/(4*A*(L*Vz - 2*sinh((L*Vz)/2) + 2*L*Vz*sinh((L*Vz)/4)**2 + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2))**2)
    et[3,5] = Mya/2 + ((Oy*L**2*Vy**2 - 1)*(Mya + Myb)*(L*Vy - 2*sinh(L*Vy) - 2*cosh(L*Vy) + L*Vy*(cosh(L*Vy) + sinh(L*Vy)) + 2))/(L**2*Vy**2*(cosh(L*Vy) + sinh(L*Vy) - 1))
    et[4,6] = Mya/L
    et[5,7] = -(A*L**2*Vy**2*P - 8*A*P*sinh((L*Vy)/2)**2 - Iz*L**2*Vy**4*P + Iz*L*Vy**3*P*sinh(L*Vy) - A*E*Iz*L**2*Vy**4 - 2*A*L**4*Vy**4*Oy*P + A*L*Vy*P*sinh(L*Vy) + A*L**6*Vy**6*Oy**2*P - 2*A*L**3*Vy**3*Oy*P*sinh(L*Vy) + 16*A*L**2*Vy**2*Oy*P*sinh((L*Vy)/2)**2 + A*L**5*Vy**5*Oy**2*P*sinh(L*Vy) + A*E*Iz*L*Vy**3*sinh(L*Vy) - 8*A*L**4*Vy**4*Oy**2*P*sinh((L*Vy)/2)**2 + A*E*Iz*L**4*Vy**6*Oy + A*E*Iz*L**3*Vy**5*Oy*sinh(L*Vy))/(4*A*(L*Vy - 2*sinh((L*Vy)/2) + 2*L*Vy*sinh((L*Vy)/4)**2 + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2))**2)
    et[7,9] = -Myb/L
    et[8,10] = (A*L**2*Vz**2*P - 8*A*P*sinh((L*Vz)/2)**2 - Iy*L**2*Vz**4*P + Iy*L*Vz**3*P*sinh(L*Vz) - A*E*Iy*L**2*Vz**4 - 2*A*L**4*Vz**4*Oz*P + A*L*Vz*P*sinh(L*Vz) + A*L**6*Vz**6*Oz**2*P - 2*A*L**3*Vz**3*Oz*P*sinh(L*Vz) + 16*A*L**2*Vz**2*Oz*P*sinh((L*Vz)/2)**2 + A*L**5*Vz**5*Oz**2*P*sinh(L*Vz) + A*E*Iy*L*Vz**3*sinh(L*Vz) - 8*A*L**4*Vz**4*Oz**2*P*sinh((L*Vz)/2)**2 + A*E*Iy*L**4*Vz**6*Oz + A*E*Iy*L**3*Vz**5*Oz*sinh(L*Vz))/(4*A*(L*Vz - 2*sinh((L*Vz)/2) + 2*L*Vz*sinh((L*Vz)/4)**2 + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2))**2)
    et[9,11] = Myb/2 + ((Oy*L**2*Vy**2 - 1)*(Mya + Myb)*(L*Vy - 2*sinh(L*Vy) - 2*cosh(L*Vy) + L*Vy*(cosh(L*Vy) + sinh(L*Vy)) + 2))/(L**2*Vy**2*(cosh(L*Vy) + sinh(L*Vy) - 1))

    et[1,4] = (Vy**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vz)/2)*(Vy**2 - Vz**2)*(L*Vy*cosh((L*Vy)/2) - 2*sinh((L*Vy)/2) + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2)))
    et[2,5] = (Vz**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vy)/2)*(Vy**2 - Vz**2)*(L*Vz*cosh((L*Vz)/2) - 2*sinh((L*Vz)/2) + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2)))
    et[4,7] = -(Vy**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vz)/2)*(Vy**2 - Vz**2)*(L*Vy*cosh((L*Vy)/2) - 2*sinh((L*Vy)/2) + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2)))
    et[5,8] = -(Vz**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vy)/2)*(Vy**2 - Vz**2)*(L*Vz*cosh((L*Vz)/2) - 2*sinh((L*Vz)/2) + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2)))
    et[7,10] = (Vy**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vz)/2)*(Vy**2 - Vz**2)*(L*Vy*cosh((L*Vy)/2) - 2*sinh((L*Vy)/2) + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2)))
    et[8,11] = (Vz**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vy)/2)*(Vy**2 - Vz**2)*(L*Vz*cosh((L*Vz)/2) - 2*sinh((L*Vz)/2) + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2)))

    et[0,4] = -Mya/L
    et[1,5] = (A*L**2*Vy**2*P - 8*A*P*sinh((L*Vy)/2)**2 - Iz*L**2*Vy**4*P + Iz*L*Vy**3*P*sinh(L*Vy) - A*E*Iz*L**2*Vy**4 - 2*A*L**4*Vy**4*Oy*P + A*L*Vy*P*sinh(L*Vy) + A*L**6*Vy**6*Oy**2*P - 2*A*L**3*Vy**3*Oy*P*sinh(L*Vy) + 16*A*L**2*Vy**2*Oy*P*sinh((L*Vy)/2)**2 + A*L**5*Vy**5*Oy**2*P*sinh(L*Vy) + A*E*Iz*L*Vy**3*sinh(L*Vy) - 8*A*L**4*Vy**4*Oy**2*P*sinh((L*Vy)/2)**2 + A*E*Iz*L**4*Vy**6*Oy + A*E*Iz*L**3*Vy**5*Oy*sinh(L*Vy))/(4*A*(L*Vy - 2*sinh((L*Vy)/2) + 2*L*Vy*sinh((L*Vy)/4)**2 + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2))**2)
    et[3,7] = -Mya/L
    et[4,8] = (A*L**2*Vz**2*P - 8*A*P*sinh((L*Vz)/2)**2 - Iy*L**2*Vz**4*P + Iy*L*Vz**3*P*sinh(L*Vz) - A*E*Iy*L**2*Vz**4 - 2*A*L**4*Vz**4*Oz*P + A*L*Vz*P*sinh(L*Vz) + A*L**6*Vz**6*Oz**2*P - 2*A*L**3*Vz**3*Oz*P*sinh(L*Vz) + 16*A*L**2*Vz**2*Oz*P*sinh((L*Vz)/2)**2 + A*L**5*Vz**5*Oz**2*P*sinh(L*Vz) + A*E*Iy*L*Vz**3*sinh(L*Vz) - 8*A*L**4*Vz**4*Oz**2*P*sinh((L*Vz)/2)**2 + A*E*Iy*L**4*Vz**6*Oz + A*E*Iy*L**3*Vz**5*Oz*sinh(L*Vz))/(4*A*(L*Vz - 2*sinh((L*Vz)/2) + 2*L*Vz*sinh((L*Vz)/4)**2 + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2))**2)
    et[5,9] = -((Oy*L**2*Vy**2 - 1)*((L*Vy*cosh((L*Vy)/2))/sinh((L*Vy)/2) - 2)*(Mya + Myb))/(L**2*Vy**2)
    et[6,10] = Myb/L
    et[7,11] = -(A*L**2*Vy**2*P - 8*A*P*sinh((L*Vy)/2)**2 - Iz*L**2*Vy**4*P + Iz*L*Vy**3*P*sinh(L*Vy) - A*E*Iz*L**2*Vy**4 - 2*A*L**4*Vy**4*Oy*P + A*L*Vy*P*sinh(L*Vy) + A*L**6*Vy**6*Oy**2*P - 2*A*L**3*Vy**3*Oy*P*sinh(L*Vy) + 16*A*L**2*Vy**2*Oy*P*sinh((L*Vy)/2)**2 + A*L**5*Vy**5*Oy**2*P*sinh(L*Vy) + A*E*Iz*L*Vy**3*sinh(L*Vy) - 8*A*L**4*Vy**4*Oy**2*P*sinh((L*Vy)/2)**2 + A*E*Iz*L**4*Vy**6*Oy + A*E*Iz*L**3*Vy**5*Oy*sinh(L*Vy))/(4*A*(L*Vy - 2*sinh((L*Vy)/2) + 2*L*Vy*sinh((L*Vy)/4)**2 + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2))**2)

    et[0,5] = -Mza/L
    et[3,8] = -Mza/L
    et[4,9] = ((Oz*L**2*Vz**2 - 1)*((L*Vz*cosh((L*Vz)/2))/sinh((L*Vz)/2) - 2)*(Mza + Mzb))/(L**2*Vz**2)
    et[5,10] = (2*Mxb*(4*Vy**2 - 4*Vz**2 - 4*Vy**2*cosh((L*Vy)/2)**2 - 4*Vy**2*cosh((L*Vz)/2)**2 + 4*Vz**2*cosh((L*Vy)/2)**2 + 4*Vz**2*cosh((L*Vz)/2)**2 - 4*L**2*Vy**4*Oy + 4*L**2*Vz**4*Oz + 4*Vy**2*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 4*Vz**2*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 2*L*Vy*Vz**2*sinh(L*Vy) + 2*L*Vy**2*Vz*sinh(L*Vz) + L**2*Vy**2*Vz**2*cosh((L*Vy)/2)**2 - L**2*Vy**2*Vz**2*cosh((L*Vz)/2)**2 + 4*L**2*Vy**2*Vz**2*Oy - 4*L**2*Vy**2*Vz**2*Oz + 4*L**2*Vy**4*Oy*cosh((L*Vy)/2)**2 + 4*L**2*Vy**4*Oy*cosh((L*Vz)/2)**2 - 4*L**2*Vz**4*Oz*cosh((L*Vy)/2)**2 - 4*L**2*Vz**4*Oz*cosh((L*Vz)/2)**2 - 4*L**4*Vy**2*Vz**4*Oy*Oz + 4*L**4*Vy**4*Vz**2*Oy*Oz + L**3*Vy**3*Vz**2*Oy*sinh(L*Vy) - L**3*Vy**2*Vz**3*Oz*sinh(L*Vz) - 4*L**2*Vy**2*Vz**2*Oy*cosh((L*Vy)/2)**2 - 4*L**2*Vy**2*Vz**2*Oy*cosh((L*Vz)/2)**2 + 4*L**2*Vy**2*Vz**2*Oz*cosh((L*Vy)/2)**2 + 4*L**2*Vy**2*Vz**2*Oz*cosh((L*Vz)/2)**2 - 4*L**2*Vy**4*Oy*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + 4*L**2*Vz**4*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + L**3*Vy*Vz**4*Oz*sinh(L*Vy) - L**3*Vy**4*Vz*Oy*sinh(L*Vz) + 4*L*Vy*Vz**2*cosh((L*Vy)/2)*cosh((L*Vz)/2)**2*sinh((L*Vy)/2) - 4*L*Vy**2*Vz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)*sinh((L*Vz)/2) + 4*L**2*Vy**2*Vz**2*Oy*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 4*L**2*Vy**2*Vz**2*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + 4*L**4*Vy**2*Vz**4*Oy*Oz*cosh((L*Vy)/2)**2 - 4*L**4*Vy**4*Vz**2*Oy*Oz*cosh((L*Vy)/2)**2 + 4*L**4*Vy**2*Vz**4*Oy*Oz*cosh((L*Vz)/2)**2 - 4*L**4*Vy**4*Vz**2*Oy*Oz*cosh((L*Vz)/2)**2 - 2*L**3*Vy**3*Vz**2*Oy*cosh((L*Vy)/2)*cosh((L*Vz)/2)**2*sinh((L*Vy)/2) + 2*L**3*Vy**2*Vz**3*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)*sinh((L*Vz)/2) - 4*L**4*Vy**2*Vz**4*Oy*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + 4*L**4*Vy**4*Vz**2*Oy*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 2*L**3*Vy*Vz**4*Oz*cosh((L*Vy)/2)*cosh((L*Vz)/2)**2*sinh((L*Vy)/2) + 2*L**3*Vy**4*Vz*Oy*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)*sinh((L*Vz)/2)))/((Vy**2 - Vz**2)*(L*Vy*sinh(L*Vy) - 2*L**2*Vy**2*Oy - 2*cosh(L*Vy) + 2*L**2*Vy**2*Oy*cosh(L*Vy) + 2)*(L*Vz*sinh(L*Vz) - 2*L**2*Vz**2*Oz - 2*cosh(L*Vz) + 2*L**2*Vz**2*Oz*cosh(L*Vz) + 2))
    et[6,11] = Mzb/L

    et[0,6] = - P/L - (A*E)/L
    et[1,7] = -(Vy*(Iz*Vy**2*P*sinh(L*Vy) - 3*A*P*sinh(L*Vy) + 2*A*L*Vy*P - Iz*L*Vy**3*P - A*E*Iz*L*Vy**3 + A*E*Iz*Vy**2*sinh(L*Vy) - 2*A*L**3*Vy**3*Oy*P + A*L*Vy*P*cosh(L*Vy) + A*L**5*Vy**5*Oy**2*P + 2*A*L**2*Vy**2*Oy*P*sinh(L*Vy) + A*L**4*Vy**4*Oy**2*P*sinh(L*Vy) + A*E*Iz*L**3*Vy**5*Oy + A*E*Iz*L**2*Vy**4*Oy*sinh(L*Vy)))/(2*A*(L*Vy*cosh((L*Vy)/2) - 2*sinh((L*Vy)/2) + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2))**2)
    et[2,8] = -(Vz*(Iy*Vz**2*P*sinh(L*Vz) - 3*A*P*sinh(L*Vz) + 2*A*L*Vz*P - Iy*L*Vz**3*P - A*E*Iy*L*Vz**3 + A*E*Iy*Vz**2*sinh(L*Vz) - 2*A*L**3*Vz**3*Oz*P + A*L*Vz*P*cosh(L*Vz) + A*L**5*Vz**5*Oz**2*P + 2*A*L**2*Vz**2*Oz*P*sinh(L*Vz) + A*L**4*Vz**4*Oz**2*P*sinh(L*Vz) + A*E*Iy*L**3*Vz**5*Oz + A*E*Iy*L**2*Vz**4*Oz*sinh(L*Vz)))/(2*A*(L*Vz*cosh((L*Vz)/2) - 2*sinh((L*Vz)/2) + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2))**2)
    et[4,10] = -(Jp*P)/(A*L)
    et[4,10] = (2*A*P*sinh(L*Vz) - A*P*sinh(2*L*Vz) + 2*Iy*Vz**2*P*sinh(L*Vz) - Iy*Vz**2*P*sinh(2*L*Vz) - 6*A*L*Vz*P + Iy*L*Vz**3*P + A*E*Iy*L*Vz**3 + 2*A*E*Iy*Vz**2*sinh(L*Vz) - A*E*Iy*Vz**2*sinh(2*L*Vz) - 2*Iy*L*Vz**3*P*cosh(L*Vz) + Iy*L*Vz**3*P*cosh(2*L*Vz) + 17*A*L**3*Vz**3*Oz*P - 3*Iy*L**3*Vz**5*Oz*P + A*L**3*Vz**3*P*cosh(L*Vz) - Iy*L**3*Vz**5*P*cosh(L*Vz) - 3*A*L**2*Vz**2*P*sinh(L*Vz) + Iy*L**2*Vz**4*P*sinh(L*Vz) + 6*A*L*Vz*P*cosh(L*Vz) - 18*A*L**5*Vz**5*Oz**2*P + 9*A*L**7*Vz**7*Oz**3*P - 2*A*L**9*Vz**9*Oz**4*P + 2*Iy*L**5*Vz**7*Oz**2*P - 8*A*L**2*Vz**2*Oz*P*sinh(L*Vz) + 4*A*L**2*Vz**2*Oz*P*sinh(2*L*Vz) + 8*A*L**4*Vz**4*Oz*P*sinh(L*Vz) - 4*Iy*L**2*Vz**4*Oz*P*sinh(L*Vz) + 2*Iy*L**2*Vz**4*Oz*P*sinh(2*L*Vz) - 2*Iy*L**4*Vz**6*Oz*P*sinh(L*Vz) + 7*A*E*Iy*L**5*Vz**7*Oz**2 - 2*A*E*Iy*L**7*Vz**9*Oz**3 + 16*A*L**5*Vz**5*Oz**2*P*cosh(L*Vz) + 2*A*L**5*Vz**5*Oz**2*P*cosh(2*L*Vz) + A*L**7*Vz**7*Oz**2*P*cosh(L*Vz) - 8*A*L**7*Vz**7*Oz**3*P*cosh(L*Vz) - A*L**7*Vz**7*Oz**3*P*cosh(2*L*Vz) + 2*A*L**9*Vz**9*Oz**4*P*cosh(L*Vz) - 2*Iy*L**5*Vz**7*Oz**2*P*cosh(L*Vz) + 12*A*L**4*Vz**4*Oz**2*P*sinh(L*Vz) - 6*A*L**4*Vz**4*Oz**2*P*sinh(2*L*Vz) - 7*A*L**6*Vz**6*Oz**2*P*sinh(L*Vz) - 8*A*L**6*Vz**6*Oz**3*P*sinh(L*Vz) + 4*A*L**6*Vz**6*Oz**3*P*sinh(2*L*Vz) + 2*A*L**8*Vz**8*Oz**3*P*sinh(L*Vz) + 2*A*L**8*Vz**8*Oz**4*P*sinh(L*Vz) - A*L**8*Vz**8*Oz**4*P*sinh(2*L*Vz) + 2*Iy*L**4*Vz**6*Oz**2*P*sinh(L*Vz) - Iy*L**4*Vz**6*Oz**2*P*sinh(2*L*Vz) - 2*A*E*Iy*L*Vz**3*cosh(L*Vz) + A*E*Iy*L*Vz**3*cosh(2*L*Vz) - 6*A*E*Iy*L**3*Vz**5*Oz - A*E*Iy*L**3*Vz**5*cosh(L*Vz) + A*E*Iy*L**2*Vz**4*sinh(L*Vz) - 16*A*L**3*Vz**3*Oz*P*cosh(L*Vz) - A*L**3*Vz**3*Oz*P*cosh(2*L*Vz) - 2*A*L**5*Vz**5*Oz*P*cosh(L*Vz) + 4*Iy*L**3*Vz**5*Oz*P*cosh(L*Vz) - Iy*L**3*Vz**5*Oz*P*cosh(2*L*Vz) + 6*A*E*Iy*L**3*Vz**5*Oz*cosh(L*Vz) + A*E*Iy*L**5*Vz**7*Oz*cosh(L*Vz) - 2*A*E*Iy*L**2*Vz**4*Oz*sinh(L*Vz) + A*E*Iy*L**2*Vz**4*Oz*sinh(2*L*Vz) - 5*A*E*Iy*L**4*Vz**6*Oz*sinh(L*Vz) - 6*A*E*Iy*L**5*Vz**7*Oz**2*cosh(L*Vz) - A*E*Iy*L**5*Vz**7*Oz**2*cosh(2*L*Vz) + 2*A*E*Iy*L**7*Vz**9*Oz**3*cosh(L*Vz) - 2*A*E*Iy*L**4*Vz**6*Oz**2*sinh(L*Vz) + A*E*Iy*L**4*Vz**6*Oz**2*sinh(2*L*Vz) + 2*A*E*Iy*L**6*Vz**8*Oz**2*sinh(L*Vz) + 2*A*E*Iy*L**6*Vz**8*Oz**3*sinh(L*Vz) - A*E*Iy*L**6*Vz**8*Oz**3*sinh(2*L*Vz))/(A*Vz*(4*cosh(2*L*Vz) - 16*cosh(L*Vz) - L**2*Vz**2 - 24*L**2*Vz**2*Oz + L**2*Vz**2*cosh(2*L*Vz) + 8*L*Vz*sinh(L*Vz) - 4*L*Vz*sinh(2*L*Vz) + 12*L**4*Vz**4*Oz**2 + 32*L**2*Vz**2*Oz*cosh(L*Vz) - 8*L**2*Vz**2*Oz*cosh(2*L*Vz) - 8*L**3*Vz**3*Oz*sinh(L*Vz) + 4*L**3*Vz**3*Oz*sinh(2*L*Vz) - 16*L**4*Vz**4*Oz**2*cosh(L*Vz) + 4*L**4*Vz**4*Oz**2*cosh(2*L*Vz) + 12))
    et[5,11] = (2*A*P*sinh(L*Vy) - A*P*sinh(2*L*Vy) + 2*Iz*Vy**2*P*sinh(L*Vy) - Iz*Vy**2*P*sinh(2*L*Vy) - 6*A*L*Vy*P + Iz*L*Vy**3*P + A*E*Iz*L*Vy**3 + 2*A*E*Iz*Vy**2*sinh(L*Vy) - A*E*Iz*Vy**2*sinh(2*L*Vy) - 2*Iz*L*Vy**3*P*cosh(L*Vy) + Iz*L*Vy**3*P*cosh(2*L*Vy) + 17*A*L**3*Vy**3*Oy*P - 3*Iz*L**3*Vy**5*Oy*P + A*L**3*Vy**3*P*cosh(L*Vy) - Iz*L**3*Vy**5*P*cosh(L*Vy) - 3*A*L**2*Vy**2*P*sinh(L*Vy) + Iz*L**2*Vy**4*P*sinh(L*Vy) + 6*A*L*Vy*P*cosh(L*Vy) - 18*A*L**5*Vy**5*Oy**2*P + 9*A*L**7*Vy**7*Oy**3*P - 2*A*L**9*Vy**9*Oy**4*P + 2*Iz*L**5*Vy**7*Oy**2*P - 8*A*L**2*Vy**2*Oy*P*sinh(L*Vy) + 4*A*L**2*Vy**2*Oy*P*sinh(2*L*Vy) + 8*A*L**4*Vy**4*Oy*P*sinh(L*Vy) - 4*Iz*L**2*Vy**4*Oy*P*sinh(L*Vy) + 2*Iz*L**2*Vy**4*Oy*P*sinh(2*L*Vy) - 2*Iz*L**4*Vy**6*Oy*P*sinh(L*Vy) + 7*A*E*Iz*L**5*Vy**7*Oy**2 - 2*A*E*Iz*L**7*Vy**9*Oy**3 + 16*A*L**5*Vy**5*Oy**2*P*cosh(L*Vy) + 2*A*L**5*Vy**5*Oy**2*P*cosh(2*L*Vy) + A*L**7*Vy**7*Oy**2*P*cosh(L*Vy) - 8*A*L**7*Vy**7*Oy**3*P*cosh(L*Vy) - A*L**7*Vy**7*Oy**3*P*cosh(2*L*Vy) + 2*A*L**9*Vy**9*Oy**4*P*cosh(L*Vy) - 2*Iz*L**5*Vy**7*Oy**2*P*cosh(L*Vy) + 12*A*L**4*Vy**4*Oy**2*P*sinh(L*Vy) - 6*A*L**4*Vy**4*Oy**2*P*sinh(2*L*Vy) - 7*A*L**6*Vy**6*Oy**2*P*sinh(L*Vy) - 8*A*L**6*Vy**6*Oy**3*P*sinh(L*Vy) + 4*A*L**6*Vy**6*Oy**3*P*sinh(2*L*Vy) + 2*A*L**8*Vy**8*Oy**3*P*sinh(L*Vy) + 2*A*L**8*Vy**8*Oy**4*P*sinh(L*Vy) - A*L**8*Vy**8*Oy**4*P*sinh(2*L*Vy) + 2*Iz*L**4*Vy**6*Oy**2*P*sinh(L*Vy) - Iz*L**4*Vy**6*Oy**2*P*sinh(2*L*Vy) - 2*A*E*Iz*L*Vy**3*cosh(L*Vy) + A*E*Iz*L*Vy**3*cosh(2*L*Vy) - 6*A*E*Iz*L**3*Vy**5*Oy - A*E*Iz*L**3*Vy**5*cosh(L*Vy) + A*E*Iz*L**2*Vy**4*sinh(L*Vy) - 16*A*L**3*Vy**3*Oy*P*cosh(L*Vy) - A*L**3*Vy**3*Oy*P*cosh(2*L*Vy) - 2*A*L**5*Vy**5*Oy*P*cosh(L*Vy) + 4*Iz*L**3*Vy**5*Oy*P*cosh(L*Vy) - Iz*L**3*Vy**5*Oy*P*cosh(2*L*Vy) + 6*A*E*Iz*L**3*Vy**5*Oy*cosh(L*Vy) + A*E*Iz*L**5*Vy**7*Oy*cosh(L*Vy) - 2*A*E*Iz*L**2*Vy**4*Oy*sinh(L*Vy) + A*E*Iz*L**2*Vy**4*Oy*sinh(2*L*Vy) - 5*A*E*Iz*L**4*Vy**6*Oy*sinh(L*Vy) - 6*A*E*Iz*L**5*Vy**7*Oy**2*cosh(L*Vy) - A*E*Iz*L**5*Vy**7*Oy**2*cosh(2*L*Vy) + 2*A*E*Iz*L**7*Vy**9*Oy**3*cosh(L*Vy) - 2*A*E*Iz*L**4*Vy**6*Oy**2*sinh(L*Vy) + A*E*Iz*L**4*Vy**6*Oy**2*sinh(2*L*Vy) + 2*A*E*Iz*L**6*Vy**8*Oy**2*sinh(L*Vy) + 2*A*E*Iz*L**6*Vy**8*Oy**3*sinh(L*Vy) - A*E*Iz*L**6*Vy**8*Oy**3*sinh(2*L*Vy))/(A*Vy*(4*cosh(2*L*Vy) - 16*cosh(L*Vy) - L**2*Vy**2 - 24*L**2*Vy**2*Oy + L**2*Vy**2*cosh(2*L*Vy) + 8*L*Vy*sinh(L*Vy) - 4*L*Vy*sinh(2*L*Vy) + 12*L**4*Vy**4*Oy**2 + 32*L**2*Vy**2*Oy*cosh(L*Vy) - 8*L**2*Vy**2*Oy*cosh(2*L*Vy) - 8*L**3*Vy**3*Oy*sinh(L*Vy) + 4*L**3*Vy**3*Oy*sinh(2*L*Vy) - 16*L**4*Vy**4*Oy**2*cosh(L*Vy) + 4*L**4*Vy**4*Oy**2*cosh(2*L*Vy) + 12))

    et[2,9] = Mzb/L
    et[3,10] = ((Oz*L**2*Vz**2 - 1)*((L*Vz*cosh((L*Vz)/2))/sinh((L*Vz)/2) - 2)*(Mza + Mzb))/(L**2*Vz**2)
    et[4,11] = -(2*Mxb*(4*Vy**2 - 4*Vz**2 - 4*Vy**2*cosh((L*Vy)/2)**2 - 4*Vy**2*cosh((L*Vz)/2)**2 + 4*Vz**2*cosh((L*Vy)/2)**2 + 4*Vz**2*cosh((L*Vz)/2)**2 - 4*L**2*Vy**4*Oy + 4*L**2*Vz**4*Oz + 4*Vy**2*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 4*Vz**2*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 2*L*Vy*Vz**2*sinh(L*Vy) + 2*L*Vy**2*Vz*sinh(L*Vz) + L**2*Vy**2*Vz**2*cosh((L*Vy)/2)**2 - L**2*Vy**2*Vz**2*cosh((L*Vz)/2)**2 + 4*L**2*Vy**2*Vz**2*Oy - 4*L**2*Vy**2*Vz**2*Oz + 4*L**2*Vy**4*Oy*cosh((L*Vy)/2)**2 + 4*L**2*Vy**4*Oy*cosh((L*Vz)/2)**2 - 4*L**2*Vz**4*Oz*cosh((L*Vy)/2)**2 - 4*L**2*Vz**4*Oz*cosh((L*Vz)/2)**2 - 4*L**4*Vy**2*Vz**4*Oy*Oz + 4*L**4*Vy**4*Vz**2*Oy*Oz + L**3*Vy**3*Vz**2*Oy*sinh(L*Vy) - L**3*Vy**2*Vz**3*Oz*sinh(L*Vz) - 4*L**2*Vy**2*Vz**2*Oy*cosh((L*Vy)/2)**2 - 4*L**2*Vy**2*Vz**2*Oy*cosh((L*Vz)/2)**2 + 4*L**2*Vy**2*Vz**2*Oz*cosh((L*Vy)/2)**2 + 4*L**2*Vy**2*Vz**2*Oz*cosh((L*Vz)/2)**2 - 4*L**2*Vy**4*Oy*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + 4*L**2*Vz**4*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + L**3*Vy*Vz**4*Oz*sinh(L*Vy) - L**3*Vy**4*Vz*Oy*sinh(L*Vz) + 4*L*Vy*Vz**2*cosh((L*Vy)/2)*cosh((L*Vz)/2)**2*sinh((L*Vy)/2) - 4*L*Vy**2*Vz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)*sinh((L*Vz)/2) + 4*L**2*Vy**2*Vz**2*Oy*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 4*L**2*Vy**2*Vz**2*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + 4*L**4*Vy**2*Vz**4*Oy*Oz*cosh((L*Vy)/2)**2 - 4*L**4*Vy**4*Vz**2*Oy*Oz*cosh((L*Vy)/2)**2 + 4*L**4*Vy**2*Vz**4*Oy*Oz*cosh((L*Vz)/2)**2 - 4*L**4*Vy**4*Vz**2*Oy*Oz*cosh((L*Vz)/2)**2 - 2*L**3*Vy**3*Vz**2*Oy*cosh((L*Vy)/2)*cosh((L*Vz)/2)**2*sinh((L*Vy)/2) + 2*L**3*Vy**2*Vz**3*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)*sinh((L*Vz)/2) - 4*L**4*Vy**2*Vz**4*Oy*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 + 4*L**4*Vy**4*Vz**2*Oy*Oz*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)**2 - 2*L**3*Vy*Vz**4*Oz*cosh((L*Vy)/2)*cosh((L*Vz)/2)**2*sinh((L*Vy)/2) + 2*L**3*Vy**4*Vz*Oy*cosh((L*Vy)/2)**2*cosh((L*Vz)/2)*sinh((L*Vz)/2)))/((Vy**2 - Vz**2)*(L*Vy*sinh(L*Vy) - 2*L**2*Vy**2*Oy - 2*cosh(L*Vy) + 2*L**2*Vy**2*Oy*cosh(L*Vy) + 2)*(L*Vz*sinh(L*Vz) - 2*L**2*Vz**2*Oz - 2*cosh(L*Vz) + 2*L**2*Vz**2*Oz*cosh(L*Vz) + 2))

    et[1,9] = Myb/L
    et[2,10] = -(A*L**2*Vz**2*P - 8*A*P*sinh((L*Vz)/2)**2 - Iy*L**2*Vz**4*P + Iy*L*Vz**3*P*sinh(L*Vz) - A*E*Iy*L**2*Vz**4 - 2*A*L**4*Vz**4*Oz*P + A*L*Vz*P*sinh(L*Vz) + A*L**6*Vz**6*Oz**2*P - 2*A*L**3*Vz**3*Oz*P*sinh(L*Vz) + 16*A*L**2*Vz**2*Oz*P*sinh((L*Vz)/2)**2 + A*L**5*Vz**5*Oz**2*P*sinh(L*Vz) + A*E*Iy*L*Vz**3*sinh(L*Vz) - 8*A*L**4*Vz**4*Oz**2*P*sinh((L*Vz)/2)**2 + A*E*Iy*L**4*Vz**6*Oz + A*E*Iy*L**3*Vz**5*Oz*sinh(L*Vz))/(4*A*(L*Vz - 2*sinh((L*Vz)/2) + 2*L*Vz*sinh((L*Vz)/4)**2 + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2))**2)
    et[3,11] = -((Oy*L**2*Vy**2 - 1)*((L*Vy*cosh((L*Vy)/2))/sinh((L*Vy)/2) - 2)*(Mya + Myb))/(L**2*Vy**2)

    et[1,10] = -(Vy**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vz)/2)*(Vy**2 - Vz**2)*(L*Vy*cosh((L*Vy)/2) - 2*sinh((L*Vy)/2) + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2)))
    et[2,11] = -(Vz**2*Mxb*(Vy*cosh((L*Vy)/2)*sinh((L*Vz)/2) - Vz*cosh((L*Vz)/2)*sinh((L*Vy)/2)))/(sinh((L*Vy)/2)*(Vy**2 - Vz**2)*(L*Vz*cosh((L*Vz)/2) - 2*sinh((L*Vz)/2) + 2*L**2*Vz**2*Oz*sinh((L*Vz)/2)))

    et[0,10] = -Myb/L
    et[1,11] = (A*L**2*Vy**2*P - 8*A*P*sinh((L*Vy)/2)**2 - Iz*L**2*Vy**4*P + Iz*L*Vy**3*P*sinh(L*Vy) - A*E*Iz*L**2*Vy**4 - 2*A*L**4*Vy**4*Oy*P + A*L*Vy*P*sinh(L*Vy) + A*L**6*Vy**6*Oy**2*P - 2*A*L**3*Vy**3*Oy*P*sinh(L*Vy) + 16*A*L**2*Vy**2*Oy*P*sinh((L*Vy)/2)**2 + A*L**5*Vy**5*Oy**2*P*sinh(L*Vy) + A*E*Iz*L*Vy**3*sinh(L*Vy) - 8*A*L**4*Vy**4*Oy**2*P*sinh((L*Vy)/2)**2 + A*E*Iz*L**4*Vy**6*Oy + A*E*Iz*L**3*Vy**5*Oy*sinh(L*Vy))/(4*A*(L*Vy - 2*sinh((L*Vy)/2) + 2*L*Vy*sinh((L*Vy)/4)**2 + 2*L**2*Vy**2*Oy*sinh((L*Vy)/2))**2)

    et[0,11] = -Mzb/L

    et[4,5] = (L**2*(2*Vy**2*Vz**2*Mxb*(sinh((L*Vy)/2)**2 - 2*(sinh((L*Vy)/2)**2 + 1)*(sinh((L*Vz)/2)**2 + 1) + sinh((L*Vz)/2)**2 + 2) + (Vy*Vz**3*Mxb*sinh(L*Vy)*sinh(L*Vz))/2 + (Vy**3*Vz*Mxb*sinh(L*Vy)*sinh(L*Vz))/2) + L*(2*Vy**3*Mxb*(sinh(L*Vy) - 2*sinh((L*Vy)/2)*(sinh((L*Vz)/2)**2 + 1)*(2*sinh((L*Vy)/4)**2 + 1)) + 2*Vz**3*Mxb*(sinh(L*Vz) - 2*sinh((L*Vz)/2)*(sinh((L*Vy)/2)**2 + 1)*(2*sinh((L*Vz)/4)**2 + 1)) - 2*Vy*Vz**2*Mxb*(sinh(L*Vy) - 2*sinh((L*Vy)/2)*(sinh((L*Vz)/2)**2 + 1)*(2*sinh((L*Vy)/4)**2 + 1)) - 2*Vy**2*Vz*Mxb*(sinh(L*Vz) - 2*sinh((L*Vz)/2)*(sinh((L*Vy)/2)**2 + 1)*(2*sinh((L*Vz)/4)**2 + 1))) + L**3*(2*Vy**3*Vz**2*Mxb*(Oy*sinh(L*Vy) - Oz*sinh(L*Vy) - 2*Oy*sinh((L*Vy)/2)*(sinh((L*Vz)/2)**2 + 1)*(2*sinh((L*Vy)/4)**2 + 1) + 2*Oz*sinh((L*Vy)/2)*(sinh((L*Vz)/2)**2 + 1)*(2*sinh((L*Vy)/4)**2 + 1)) - 2*Vy**2*Vz**3*Mxb*(Oy*sinh(L*Vz) - Oz*sinh(L*Vz) - 2*Oy*sinh((L*Vz)/2)*(sinh((L*Vy)/2)**2 + 1)*(2*sinh((L*Vz)/4)**2 + 1) + 2*Oz*sinh((L*Vz)/2)*(sinh((L*Vy)/2)**2 + 1)*(2*sinh((L*Vz)/4)**2 + 1))))/((Vy**2 - Vz**2)*(L*Vy*sinh(L*Vy) - 4*sinh((L*Vy)/2)**2 + 4*L**2*Vy**2*Oy*sinh((L*Vy)/2)**2)*(L*Vz*sinh(L*Vz) - 4*sinh((L*Vz)/2)**2 + 4*L**2*Vz**2*Oz*sinh((L*Vz)/2)**2))
    ...
    if Iy == Iz :
        ...
        et[5,8] = -(Vy*Mxb*(sinh(L*Vy) - L*Vy))/(2*(L*Vy*sinh(L*Vy) - 2*L**2*Vy**2*Oz - 2*cosh(L*Vy) + 2*L**2*Vy**2*Oz*cosh(L*Vy) + 2))
        et[7,10] = (Vy*Mxb*(sinh(L*Vy) - L*Vy))/(2*(L*Vy*sinh(L*Vy) - 2*L**2*Vy**2*Oy - 2*cosh(L*Vy) + 2*L**2*Vy**2*Oy*cosh(L*Vy) + 2))
        et[8,11] = (Vy*Mxb*(sinh(L*Vy) - L*Vy))/(2*(L*Vy*sinh(L*Vy) - 2*L**2*Vy**2*Oz - 2*cosh(L*Vy) + 2*L**2*Vy**2*Oz*cosh(L*Vy) + 2))

        et[5,10] = -(Mxb*(6*Vy - 8*Vy*cosh(L*Vy) + 2*Vy*cosh(2*L*Vy) + 2*L**2*Vy**3 - 6*L**2*Vy**3*Oy - 6*L**2*Vy**3*Oz - L**4*Vy**5*Oy - L**4*Vy**5*Oz - 2*L**2*Vy**3*cosh(L*Vy) + L**3*Vy**4*sinh(L*Vy) + 2*L*Vy**2*sinh(L*Vy) - L*Vy**2*sinh(2*L*Vy) + 6*L**4*Vy**5*Oy*Oz + 8*L**2*Vy**3*Oy*cosh(L*Vy) + 8*L**2*Vy**3*Oz*cosh(L*Vy) - 2*L**2*Vy**3*Oy*cosh(2*L*Vy) - 2*L**2*Vy**3*Oz*cosh(2*L*Vy) + L**4*Vy**5*Oy*cosh(L*Vy) + L**4*Vy**5*Oz*cosh(L*Vy) - L**3*Vy**4*Oy*sinh(L*Vy) - L**3*Vy**4*Oz*sinh(L*Vy) + (L**3*Vy**4*Oy*sinh(2*L*Vy))/2 + (L**3*Vy**4*Oz*sinh(2*L*Vy))/2 - 8*L**4*Vy**5*Oy*Oz*cosh(L*Vy) + 2*L**4*Vy**5*Oy*Oz*cosh(2*L*Vy)))/(Vy*(16*cosh(L*Vy) - 4*cosh(2*L*Vy) + L**2*Vy**2 + 12*L**2*Vy**2*Oy + 12*L**2*Vy**2*Oz - L**2*Vy**2*cosh(2*L*Vy) - 8*L*Vy*sinh(L*Vy) + 4*L*Vy*sinh(2*L*Vy) - 12*L**4*Vy**4*Oy*Oz - 16*L**2*Vy**2*Oy*cosh(L*Vy) - 16*L**2*Vy**2*Oz*cosh(L*Vy) + 4*L**2*Vy**2*Oy*cosh(2*L*Vy) + 4*L**2*Vy**2*Oz*cosh(2*L*Vy) + 4*L**3*Vy**3*Oy*sinh(L*Vy) + 4*L**3*Vy**3*Oz*sinh(L*Vy) - 2*L**3*Vy**3*Oy*sinh(2*L*Vy) - 2*L**3*Vy**3*Oz*sinh(2*L*Vy) + 16*L**4*Vy**4*Oy*Oz*cosh(L*Vy) - 4*L**4*Vy**4*Oy*Oz*cosh(2*L*Vy) - 12))
        et[4,11] = (Mxb*(6*Vy - 8*Vy*cosh(L*Vy) + 2*Vy*cosh(2*L*Vy) + 2*L**2*Vy**3 - 6*L**2*Vy**3*Oy - 6*L**2*Vy**3*Oz - L**4*Vy**5*Oy - L**4*Vy**5*Oz - 2*L**2*Vy**3*cosh(L*Vy) + L**3*Vy**4*sinh(L*Vy) + 2*L*Vy**2*sinh(L*Vy) - L*Vy**2*sinh(2*L*Vy) + 6*L**4*Vy**5*Oy*Oz + 8*L**2*Vy**3*Oy*cosh(L*Vy) + 8*L**2*Vy**3*Oz*cosh(L*Vy) - 2*L**2*Vy**3*Oy*cosh(2*L*Vy) - 2*L**2*Vy**3*Oz*cosh(2*L*Vy) + L**4*Vy**5*Oy*cosh(L*Vy) + L**4*Vy**5*Oz*cosh(L*Vy) - L**3*Vy**4*Oy*sinh(L*Vy) - L**3*Vy**4*Oz*sinh(L*Vy) + (L**3*Vy**4*Oy*sinh(2*L*Vy))/2 + (L**3*Vy**4*Oz*sinh(2*L*Vy))/2 - 8*L**4*Vy**5*Oy*Oz*cosh(L*Vy) + 2*L**4*Vy**5*Oy*Oz*cosh(2*L*Vy)))/(Vy*(16*cosh(L*Vy) - 4*cosh(2*L*Vy) + L**2*Vy**2 + 12*L**2*Vy**2*Oy + 12*L**2*Vy**2*Oz - L**2*Vy**2*cosh(2*L*Vy) - 8*L*Vy*sinh(L*Vy) + 4*L*Vy*sinh(2*L*Vy) - 12*L**4*Vy**4*Oy*Oz - 16*L**2*Vy**2*Oy*cosh(L*Vy) - 16*L**2*Vy**2*Oz*cosh(L*Vy) + 4*L**2*Vy**2*Oy*cosh(2*L*Vy) + 4*L**2*Vy**2*Oz*cosh(2*L*Vy) + 4*L**3*Vy**3*Oy*sinh(L*Vy) + 4*L**3*Vy**3*Oz*sinh(L*Vy) - 2*L**3*Vy**3*Oy*sinh(2*L*Vy) - 2*L**3*Vy**3*Oz*sinh(2*L*Vy) + 16*L**4*Vy**4*Oy*Oz*cosh(L*Vy) - 4*L**4*Vy**4*Oy*Oz*cosh(2*L*Vy) - 12))

        et[1,10] = -(Vy*Mxb*(sinh(L*Vy) - L*Vy))/(2*(L*Vy*sinh(L*Vy) - 2*L**2*Vy**2*Oy - 2*cosh(L*Vy) + 2*L**2*Vy**2*Oy*cosh(L*Vy) + 2))
        et[2,11] = -(Vy*Mxb*(sinh(L*Vy) - L*Vy))/(2*(L*Vy*sinh(L*Vy) - 2*L**2*Vy**2*Oz - 2*cosh(L*Vy) + 2*L**2*Vy**2*Oz*cosh(L*Vy) + 2))

        et[4,5] = -(L**3*Vy**3*Mxb*(Oy - Oz)*(sinh(L*Vy) - L*Vy))/(2*(4*cosh(L*Vy) + L**2*Vy**2 + 4*L**2*Vy**2*Oy + 4*L**2*Vy**2*Oz + L**2*Vy**2*cosh(L*Vy) - 4*L*Vy*sinh(L*Vy) - 4*L**4*Vy**4*Oy*Oz - 4*L**2*Vy**2*Oy*cosh(L*Vy) - 4*L**2*Vy**2*Oz*cosh(L*Vy) + 2*L**3*Vy**3*Oy*sinh(L*Vy) + 2*L**3*Vy**3*Oz*sinh(L*Vy) + 4*L**4*Vy**4*Oy*Oz*cosh(L*Vy) - 4))
        et[10,11] = (L**3*Vy**3*Mxb*(Oy - Oz)*(sinh(L*Vy) - L*Vy))/(2*(4*cosh(L*Vy) + L**2*Vy**2 + 4*L**2*Vy**2*Oy + 4*L**2*Vy**2*Oz + L**2*Vy**2*cosh(L*Vy) - 4*L*Vy*sinh(L*Vy) - 4*L**4*Vy**4*Oy*Oz - 4*L**2*Vy**2*Oy*cosh(L*Vy) - 4*L**2*Vy**2*Oz*cosh(L*Vy) + 2*L**3*Vy**3*Oy*sinh(L*Vy) + 2*L**3*Vy**3*Oz*sinh(L*Vy) + 4*L**4*Vy**4*Oy*Oz*cosh(L*Vy) - 4))
    #end
    # impose the geometry
    for i in range(12):
        for j in range(12):
