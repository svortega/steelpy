...
def B3D2_Ke(Le: float,
    ...
    ek[1][1] = ek[7][7] = 12.0 * emlen3 * Iy / niz
    ek[2][2] = ek[8][8] = 12.0 * emlen3 * Iz / niy
    
    ek[3][3] = ek[9][9] = Gmod * Jx / Le
    
    ek[4][4] = ek[10][10] = 4.0 * emlen * Iz * lay / niy
    ek[5][5] = ek[11][11] = 4.0 * emlen * Iy * laz / niz
    #
    ek[1][5] = ek[1][11] = 6.0 * emlen2 * Iy / niz
    ek[2][4] = ek[2][10] = -6.0 * emlen2 * Iz / niy
    #
    ek[0][6] = -ek[0][0]
    ek[1][7] = -ek[1][1]
    #
    ...
    ek[3][9] = -ek[3][3]
    ek[4][8] = -ek[2][4]
    ek[4][10] = 2.0 * emlen * Iz * gay / niy
    ek[5][7] = -ek[1][5]
    ek[5][11] = 2.0 * emlen * Iy * gaz / niz
    #
    ek[7][11] = -ek[1][5]
    ek[8][10] = -ek[2][4]
    #
