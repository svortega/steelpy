...
#import fem2ufo.f2u_model.femodel.material.material as material
...
# --------------------------------------------------------------------
#
def set_mean_material(geometry, _factor):
    """
    Set existing materail's yield sstrength to its mean value
    """
    material_set_mean(geometry.materials, _factor)
    #return _geometry
#
...
def update_materialXX(geometry, _mat_name, _mat_number):
    ...
    #return geometry
#
def add_modified_material(_type, geometry, foundation, member_list, group_list):
    """
...
def find_material_item(word_in):
    """
    """
    _key = {"Fy": r"\b((fy|yield|smys)(\s*strength|stress)?)\b",
...
# 
#
def find_material_type(word_in):
    """
    """
    _key = {"elastic": r"\b(elastic|isotropic|linear)\b",
