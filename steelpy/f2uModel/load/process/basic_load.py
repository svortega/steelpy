...
class BasicLoadMain(Mapping):
    ...
    def process(self, elements, steps:int):
        ...
        # [Fx, Fy, Fz, Mx, My, Mz]
        # [V, M, w, theta]
        header = ['load_name', 'load_comment', 'load_level', 'load_system',
    ...
    def Fn(self):
        ...
        dfnodal = dfnodal.reindex(columns=['load_name', 'load_number', 'load_level',
                                          'load_title', 'load_comment', 'load_system',
                                          'element_name', 'node_name',
                                          'Fx', 'Fy', 'Fz', 'Mx', 'My', 'Mz'])
        #
        #
        dfnodal = (dfnodal.groupby(['load_name', 'load_number', 'load_level',
    ...
    #    dftemp = self._nodes.df
        ...
        #    #    dftemp = update_df(dftemp, df2, lcase.number, lcase.title)
        #
        #dftemp = dftemp.reindex(columns=['load_name', 'load_number', 'load_level',
        #                                 'load_title', 'load_comment', 'load_system',
        #                                 'element_name', 'node_name',
        #                                 'Fx', 'Fy', 'Fz', 'Mx', 'My', 'Mz'])
        #print('-->??')
