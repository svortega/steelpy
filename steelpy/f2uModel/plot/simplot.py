...
Rectagle = Canvas.create_rectangle
...
class SimPlot:
    ...
    def plotLine(self, points:List[Tuple[float]], windowsize:Tuple[float] = (500, 300),
                 title:str = '', width:int = 1, color:str = 'black',
                 smooth:int = 0, background:str = 'white', 
                 xlab:str = 'x', ylab:str = 'y',
                 xaxis:str = 'automatic', yaxis:str = 'automatic'):
    ...
    def plotStep(self, points, windowsize = (500, 300),
                 title = '', width = 1, color = 'black',
    ...
    def plotHistogram(self, points, windowsize = (500, 300),
                      title = '', width = 1, color = 'black',
                      background = 'white', xlab = 'x', ylab = 'y',
                      xaxis = 'automatic', yaxis = 'automatic'):
    ...
    def plotBars(self, points, windowsize = (500, 300),
                 title = '', color = 'black',
    ...
    def plotScatter(self, points, windowsize = (500, 300),
                    title = '', width = 1, color = 'black',
...
@dataclass
class GraphPoints:
    __slots__ = ['points', 'scaled', 'attributes', 'anchor']

    def __init__(self, points:List[Tuple[float]], attr:Dict):
        self.points = points
    ...
    def fitToScale(self, scale:Tuple = (1, 1), shift:Tuple = (0, 0)):
        self.scaled:List = []
...
class GraphLine(GraphPoints):
    ...
    def __init__(self, points:List[Tuple[float]], **attr):
        """"""
...
class GraphBase(Frame):
    ...
    def draw(self, graphics, xaxis = 'automatic', yaxis = 'automatic'):
        ...
        # FIXME : don't know what is the issue
    ...
    def _drawAxes(self, canvas, xaxis, yaxis,
        ...
        _dict = {'anchor': N, 'fill': 'black'}
        
        if self.font is not None:
            _dict['font'] = self.font
            ...
            #d=.5 of tick - length
                ...
                if xticks:
                    for x, label in xticks:
                        ...
                        if text:
                            _dict['text'] = label
                            CanvasText(self.canvas, p[0], p[1] + 2, **_dict)    ##KGM 14 Aug 03
                text = 0
            #write x - axis title
        ...
        if yaxis is not None:
            ...
            for x, d in [(bb1[0], -3), (bb2[0], 3)]:
                ...
                if once: 
                    ...
                    pp2 = p2
                once = 0
                Line(self.canvas, p1[0], p1[1], p2[0], p2[1], fill = 'black', width = 1)
                if yticks:
                    for y, label in yticks:
                        p = (scale[0] * x) + shift[0],(scale[1] * y) + shift[1]
                        Line(self.canvas, p[0], p[1], p[0] - d, p[1], fill = 'black', width = 1)
                        if text:
                            _dict['text'] = label
                            CanvasText(self.canvas, p[0] - 4, p[1] + 2, **_dict)
                text = 0
            #write y - axis title
    ...
    def _textBoundingBox(self, text):
        ...
        _dict = {'anchor': NW, 'text': text, 'fill': bg}
        if self.font is not None:
            _dict['font'] = self.font
        item = CanvasText(self.canvas, 0., 0., **_dict)
...
if __name__ == '__main__':
    ...
    graph[1] = plt.makeGraphBase(f1, 500, 300, 
                                 title = 'Plot 1: 1 makeLine call, 1 makeBars call',
    ...
    line3 = plt2.makeLine([(1, 145 + 100),(2, 151 + 100),(3, 147 + 100),(4, 22 + 100),(5, 31 + 100),
                           (6, 77 + 100),(7, 125 + 100),(8, 220 + 100),(9, 550 + 100),(10, 560 + 100)],
                          color = 'blue', width = 2, smooth = 1)
    line3a = plt2.makeLine([(1, 145),(2, 151),(3, 147),(4, 22),(5, 31),
                            (6, 77),(7, 125),(8, 220),(9, 550),(10, 560)],
                           color = 'green', width = 2, smooth = 0)
    line3b = plt2.makeStep([(1, 145 + 100),(2, 151 + 100),(3, 147 + 100),(4, 22 + 100),(5, 31 + 100),
                            (6, 77 + 100),(7, 125 + 100),(8, 220 + 100),(9, 550 + 100),(10, 560 + 100)],
                           color = 'red', width = 2)
    
    graphObject3 = plt2.makeGraphObjects([line3, line3a, line3b])
    
    # Fourth plot -- lines with all available symbols with different
    #                outline colors / fill colors / sizes
    
    line4 = plt2.makeSymbols([(1, 100),(2, 100),(3, 100),(4, 100),(5, 100),
                              (6, 100),(7, 100),(8, 100),(9, 100),(10, 100)],
                             color = 'black', fillcolor = 'red', width = 2,
                             marker = 'triangle')
    line5 = plt2.makeSymbols([(1, 200),(2, 200),(3, 200),(4, 200),(5, 200),
                              (6, 200),(7, 200),(8, 200),(9, 200),(10, 200)],
                             color = 'red', width = 2, marker = 'circle')
    line6 = plt2.makeSymbols([(1, 300),(2, 300),(3, 300),(4, 300),(5, 300),
                              (6, 300),(7, 300),(8, 300),(9, 300),(10, 300)],
                             color = 'green', width = 2, marker = 'dot')
    line7 = plt2.makeSymbols([(1, 400),(2, 400),(3, 400),(4, 400),(5, 400),
                              (6, 400),(7, 400),(8, 400),(9, 400),(10, 400)],
                             color = 'blue', fillcolor = 'white',
                             size = 2, width = 2, marker = 'square')
    line8 = plt2.makeSymbols([(1, 500),(2, 500),(3, 500),(4, 500),(5, 500),
                              (6, 500),(7, 500),(8, 500),(9, 500),(10, 500)],
                             color = 'yellow', width = 2, marker = 'triangle')
    line9 = plt2.makeSymbols([(1, 600),(2, 600),(3, 600),(4, 600),(5, 600),
                              (6, 600),(7, 600),(8, 600),(9, 600),(10, 600)],
                             color = 'magenta', width = 2, marker = 'cross')
    line10 = plt2.makeSymbols([(1, 700),(2, 700),(3, 700),(4, 700),(5, 700),
                               (6, 700),(7, 700),(8, 700),(9, 700),(10, 700)],
                              color = 'brown', width = 2, marker = 'plus')
    line11 = plt2.makeSymbols([(1, 800),(2, 800),(3, 800),(4, 800),(5, 800),
    ...
    graph2[3] = plt2.makeGraphBase(f2, 500, 300,
                                   title = 'Plot 3: 2 makeLine call (smooth, not smooth); 1 makeStep call')
    graph2[3].pack(side = TOP, fill = BOTH, expand = YES)
    graph2[3].draw(graphObject3)
    
    graph2[4]  = plt2.makeGraphBase(f2, 500, 300, border = 3, 
                                    title = 'Plot 4: 8 makeSymbols calls')
    # Set one - over - other configuration of plots
    graph2[4].pack(side = TOP, fill = BOTH, expand = YES)
    graph2[4].draw(graphObject4)
