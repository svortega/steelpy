...
def Solve(T, H, order, current, c_type:int,
    ...
    for niter in range(iter_limit+1):
        ...
        if case == 'period':
            if c_type == 1:
                K = (T * (current + Ubar_h(epsilon, e, ee, m, mm, order) 
        ...
        if case == 'period':
            ...
            # elif(Known, Wavelength):
            if c_type == 1:
                T = (K / ((current + Ubar_h(epsilon, e, ee, m, mm, order) 
                           * math.sqrt(hoverd(H, e, ee, m, mm, order))) 
                          * math.sqrt(3 * H / m) / 4 / lambda_series(H, e, ee, m, mm, order)))
            else:
                # if (c_type == 2):
...
def Ubar_h(epsilon, e, ee, m, mm, order):
    """"""
    ...
    U_bar_Height[4] = (U_bar_Height[3] + pow(epsilon, 4) / mm[4]
                       * (2349. / 112000 + 29053. / 168000 * m - 1181. / 2100 * mm[2] + 11161. / 28000 * mm[3]
                          - 273. / 3200 * mm[4] + (29369. / 28000 * mm[2] - 15867. / 28000 * mm[3] - 5729. / 8400 * m + 1583. / 4200) * e))
...
def lambda_d(H, K, e, ee, m, mm, order):
    """ """
...
#
#
def lambda_series(H, e, ee, m, mm, order):
    """ """
    Wavelength = zeros(7)
...
def eta_h(x, alpha, epsilon, m, mm, m1, m1_limit, q1, K, Kd, order):
    """ """
    C = zeros(11)
    Eta = zeros(7)
...
def u_h(x, Y, alpha, delta, m, mm, m1, m1_limit, q1, K, Kd, order):
    ...
    uu[3] = (uu[2] + pow(delta, 3)
             * (55. / 112 + 7113. / 1120 * mm[2] - 2371. / 560 * mm[3] - 3471. / 1120 * m
                ...
                + (9. / 8 * m - 27. / 8 * mm[2] + 9. / 4 * mm[3] + C[2] * (-27. / 2 * mm[3] - 9. / 4 * m + 27. / 2 * mm[2])
    ...
    uu[5] = (uu[4] + pow(delta, 5)
             * (57159. / 98560 + 327236467. / 17248000 * mm[2] - 884845613. / 17248000 * mm[3] 
                ...
                + (1989. / 128 * mm[4] - 1989. / 320 * mm[5] - 4191. / 320 * mm[3] - 213. / 640 * m + 657. / 160 * mm[2]
                   + C[2] * (213. / 320 * m + 9753. / 80 * mm[3] - 3075. / 128 * mm[2] + 62649. / 640 * mm[5] - 62649. / 320 * mm[4])
                   + C[4] * (-139149. / 640 * mm[3] + 13563. / 640 * mm[2] - 112023. / 320 * mm[5] + 336069. / 640 * mm[4])
                ...
                + (9. / 320 * m - 387. / 640 * mm[2] - 333. / 128 * mm[4] + 171. / 80 * mm[3] + 333. / 320 * mm[5]
                   + C[2] * (-423. / 20 * mm[5] - 4077. / 160 * mm[3] + 423. / 10 * mm[4] - 9. / 160 * m + 693. / 160 * mm[2])
                ...
                + (-9. / 8960 * m + 153. / 4480 * mm[2] - 279. / 4480 * mm[5] - 81. / 640 * mm[3] + 279. / 1792 * mm[4]
                   + C[2] * (14769. / 8960 * mm[3] - 333. / 1280 * mm[2] + 6219. / 4480 * mm[5] - 6219. / 2240 * mm[4] + 9. / 4480 * m)
...
def v_h(x, Y, alpha, delta, m, mm, m1, m1_limit, q1, K, Kd, order):
    ...
    vv[3] = (vv[2] + (((27. / 16) * mm[2] * C[4]
                       + ((9. / 8) * m - (9. / 4) * mm[2]) * C[2] - (51. / 80) * m + (51. / 80) * mm[2] + 3. / 40) * y[4]
                      + (-(15. / 2) * mm[2] * C[4] + (-(25. / 4) * m + (25. / 2) * mm[2]) * C[2] - 3. / 4 - (9. / 2) * mm[2]
    ...
    vv[5] = (vv[4] + (((405. / 256) * mm[4] * C[8] + ((135. / 64) * mm[3] - (135. / 32) * mm[4]) * C[6]
                       ...
                       + (691. / 4480) * mm[4] + 1. / 4480 - (37. / 1280) * m - (691. / 2240) * mm[3] + (1641. / 8960) * mm[2]) * y[8]
                      + (-(405. / 16) * mm[4] * C[8] + (-(1125. / 32) * mm[3] + (1125. / 16) * mm[4]) * C[6]
                         ...
                         - 9. / 1120 + (99. / 160) * m - (423. / 140) * mm[4] - (4077. / 1120) * mm[2] + (423. / 70) * mm[3]) * y[6]
                      ...
                      + (-(1773. / 25) * mm[4] * C[8] + (-(3729. / 25) * mm[3] + (7458. / 25) * mm[4]) * C[6]
                         ...
                         - (77423. / 1400) * mm[4] - 53327. / 84000 + (77423. / 700) * mm[3]) * y[2] + (13438. / 1225) * mm[4] * C[8]
